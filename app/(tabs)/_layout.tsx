...
const TabIcons = ({focused,icon,title}:TabIconProp) => {
   if(focused){
     return (
        <ImageBackground source={images.highlight} className="flex flex-row w-full flex-1 gap-x-2 min-w-[112px] min-h-16 mt-4 justify-center items-center rounded-full overflow-hidden">
